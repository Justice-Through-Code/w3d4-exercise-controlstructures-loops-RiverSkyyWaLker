...
def favorite_activities():
    ...
    favorite_activities_list = []

    for day in days:
        favorite_things = input(f"What's your favorite thing to do on {day}s? ")
        favorite_activities_list.append(favorite_things)
    ...
    # favorite_activities_list.append(favorite_things)
    print(favorite_activities_list)

    for i in range(len(days)):
        print(f"On {days[i]}s, your favorite activity is to {favorite_activities_list[i]}.")
...
def temp_by_day():
    ...
    for day in days:
        temperature = int(input(f"What's the temperature on {day}? "))
        if temperature < 50:
        ...
        # print(f"Invalid temperature for {day}!")
        # continue   
